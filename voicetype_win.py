...
print("STEP1: stdlib ok", flush=True)
...
class ApexVoiceApp:
    def __init__(self):
        print("STEP2: __init__ start", flush=True)
        ...
        print("STEP3: pystray import start", flush=True)
        import pystray
        print("STEP4: pystray.Icon create start", flush=True)
